...
const Policy = () => {
  return (
    <div className='text-left'>
      ...
      <p>
        BrightSmile ("us", "we", or "our") operates the
        https://brightsmile.firebaseapp.com/#/ website (the "Service").
      </p>

      <p>
        This page informs you of our policies regarding the collection, use, and
        disclosure of personal data when you use our Service and the choices you
        have associated with that data. Our Privacy Policy for BrightSmile is
      ...
      <p>
        ...
        https://brightsmile.firebaseapp.com/#/
      </p>
      ...
      <p>BrightSmile uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        If you are located outside Viet Nam and choose to provide information to
        us, please note that we transfer the data, including Personal Data, to
        Viet Nam and process it there.
      </p>
      <p>
      ...
      <p>
        BrightSmile will take all steps reasonably necessary to ensure that your
      ...
      <p>
        BrightSmile may disclose your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of BrightSmile</li>
        <li>
      ...
      <ul>
        <li>By email: vutue11119144@gmail.com</li>
      </ul>
    </div>
  )
}
